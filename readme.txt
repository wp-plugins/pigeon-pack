...
= 1.1.0 =
* Updating WP_Widget for deprecated use in WP4.3

= 1.0.12 =
* Fixed issue with HTML entities not displaying properly in email subjects

= 1.0.11 =
* Fixing method call for profile update
